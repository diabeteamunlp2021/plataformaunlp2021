function [data] = bloq_simulacion(data,v,item,parametros,hardware,escenario,settings)
...
hardware.pump_char = 0;
    ...
    for t=tsimu
        ...
        data(v).glucosa(item) = gluc_p;
        data(v).salidas(:,item) = gluc_p;
        data(v).entradas(:,item) = u';
